...
class TestConvertingFunctions(unittest.TestCase):
    ...
    def test_converting_user_amount(self):
        input_data = ['0123456789', '123   456', '1.556', '1.554', '1 2 3', '12, 34', '12 . 34', '12.3.4', '12,3,4',
                      '12.3,4', '12a3', '12.a3', '1a.3', 'abc', '12-34', '1.', '.1', '']
        expected_result = [123456789.0, 123456.0, 1.56, 1.55, 123.0, 12.34, 12.34,
                           None, None, None, None, None, None, None, None, 1.0, None, None]
        actual_result = list()
        for el in input_data:
    ...
    def test_converting_user_pages(self):
        input_data = ['0', '1', '12', '123', '0123456789',
                      '-2', '-12', '1.', '.1', '12.34', '12,34', '1a', 'b2', 'abc', '34=56']
        expected_result = [0, 1, 12, 123, 123456789, None, None, None, None, None, None, None, None, None, None]
        actual_result = list()
        for el in input_data:
